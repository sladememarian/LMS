...
/**
 * GUI-side validation for the simulated bank-card top-up form.
 *
 * <p>The Phase-1/2 backend never validated card details (the CLI used a loose
 * "12+ digits, 3-digit CVV" check), and its {@code Validator} exposes no card
 * regex. To keep the backend untouched while still rejecting obviously invalid
 * input, the real rules live here in the GUI layer. They mirror the format the
 * form advertises ({@code 6037-xxxx-xxxx-xxxx}): a 16-digit PAN, a 3–4 digit
 * CVV, a non-blank holder and an {@code MM/YY} expiry with a sane month.</p>
 */
public final class CardValidator {
    ...
    /** True when the expiry is a well-formed {@code MM/YY} with month 01–12. */
